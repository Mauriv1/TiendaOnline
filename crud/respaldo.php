...
/*EDITAR*/		define("DB_USER", 'root');
				define("DB_PASSWORD", '982109821');
				define("DB_NAME", 'tienda_online');
				define("DB_HOST", 'localhost');
/*FIN EDITAR*/	define("BACKUP_DIR", 'Respaldos'); // Comment this line to use same script's directory ('.')
...
/*EDICIÓN OPCIONAL*/    $this->backupFile              = 'NOMBRE_RESPALDO'.$this->dbName.'-'.date("d").'.sql';
													  /* 'respaldoBD-'.$this->dbName.'-'.date("dmY_His", time()).'.sql'; */
...
<!--------FINAL, DAR FORMATO PARA PRESENTAR--------------!-->
		...
		<hr>
            <a href="listaProveedor.php" class="btn btn-primary">
                Volver
            </a>
		</div>
	</div>
